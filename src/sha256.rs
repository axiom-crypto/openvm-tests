use hex_literal::hex;
use revm_precompile::{hash::sha256_run, Bytes};

/// Vector of test cases for SHA-256 hash function.
/// Each test case consists of (test_name, input_bytes, expected_hash_result).
const SHA256_TEST_CASES: &[(&[u8], [u8; 32])] = &[
