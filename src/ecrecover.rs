...
/// Vector of test cases for ecRecover precompile.
/// Each test case consists of (input_bytes, expected_address_result).
const ECRECOVER_TEST_CASES: &[(&[u8], Option<Address>)] = &[
